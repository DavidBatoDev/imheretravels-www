...
export const tanzaniaExploration: Tour = {
  slug: "tanzania-exploration",
    ...
    items: [
      {
        icon: "transport",
        label: "Transport",
        value: "Private tour bus, Domestic flight, Safari Land Cruiser",
      },
      {
        icon: "accommodation",
        label: "Accommodation",
      ...
      },
      {
        ...
        label: "Activities",
        value: [
          "Hot Springs, Mount Kilimanjaro Day Hike, Tarangire National Park, Safari Game Drive, Sunset Cruise",
          "Add on: Parasailing, Jetski, Kayaking, Stand Up Paddleboarding, Scuba Diving",
          "Some options for the free day: Ferry Ride to Dar and Back, Zanzibar Submarine Experience, Turtle Sanctuary, Jambiani caves",
        ],
      },
      {
        icon: "meals",
      ...
      },
      {
        ...
        details: [
          ...
          },
          {
            icon: "activities",
            label: "Activities",
            value: "Blue Lagoon Zanzibar and Sunset Cruise",
          },
          {
            icon: "meals",
            label: "Meals",
      ...
      },
      {
        ...
        details: [
          ...
          },
          {
            icon: "activities",
            label: "Activities",
            value: "Mnemba and Changuu Island",
          },
          {
            icon: "meals",
            label: "Meals",
