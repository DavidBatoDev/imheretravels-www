...
export const sriLangkaWanderTour: Tour = {
  ...
  tripHighlights: {
    ...
    items: [
      {
        image: "/tours/sri-lanka-wander/srilanka-triphighlight-1.webp",
        imageAlt: "Surfing in Weligama",
        title: "Surfing in Weligama",
        subtitle: "Catch waves on Sri Lanka's south coast",
      },
      {
        image: "/tours/sri-lanka-wander/srilanka-triphighlight-2.webp",
        imageAlt: "Sigiriya Rock Fortress",
        title: "Sigiriya Rock Fortress",
        subtitle: "Climb one of Sri Lanka's most iconic landmarks",
      },
      {
        image: "/tours/sri-lanka-wander/srilanka-triphighlight-3.webp",
        imageAlt: "Scenic Train Journey",
        title: "Scenic Train Journey",
        subtitle: "Ride through tea country from Nanu Oya to Ella",
      },
    ],
  },
  itinerary: {
  ...
  faqs: {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          "Colombo Bandaranaike International Airport (CMB). They can organise a taxi back to Colombo at an additional cost (cheaper if shared with other guests).",
      },
      {
